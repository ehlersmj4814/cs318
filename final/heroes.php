                    ...
                    ?>
                            ...
                            <dt><?php echo $row1["class_name"]; ?></dt>
                                <?php while ($row2 = mysql_fetch_array($result2)){ ?>
                                    <dd>
                                        <button type="submit" name="hero_id" value="<?php echo $row2["hero_id"]; ?>"><?php echo $row2["hero_name"]; ?>
                                            <img class ="hero-thumb" src="<?php echo "images/".$row2["hero_name"].".png"; ?>" alt="<?php echo $row2["hero_name"]; ?>">
                                        </button>
                                    </dd>
